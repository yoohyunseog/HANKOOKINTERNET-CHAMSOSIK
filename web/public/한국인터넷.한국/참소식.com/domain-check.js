...
(function() {
    ...
    const DEFAULT_ALLOWED_DOMAINS = [
        '한국인터넷.한국',
        'xn--3e0bx5eku0am2irhf.xn--3e0b707e',
        '참소식.com',
        'www.참소식.com',
        'xn--9l4b4xi9r.com',
        'www.xn--9l4b4xi9r.com'
    ];
    ...
    if (!isAllowed && !isLocalhost()) {
        ...
        // 기존 404 페이지로 리다이렉트
        window.location.href = currentHost.includes('xn--9l4b4xi9r') || currentHost.includes('참소식.com')
            ? '/ErrPage/404/index.html'
            : '/참소식.com/ErrPage/404/index.html';
    } else {
